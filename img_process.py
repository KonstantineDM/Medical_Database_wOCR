...
cv2.imwrite('./samples/8_line_detected.jpg', morphed)

# Invert the morphed image, and add to the source image:
dst = cv2.add(gray, (255-morphed))
cv2.imwrite('./samples/8_line_removed.jpg', dst)
...
samples_path = r'.\samples\8_line_removed.jpg'
